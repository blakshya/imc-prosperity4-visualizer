...
export function LoadFromFile(): JSX.Element {
      ...
      new Promise<void>((resolve, reject) => {
        ...
        reader.addEventListener('load', () => {
          try {
            ...
            const algorithm = parseYear4AlgorithmLogs(content);
  ...
  return (
    <HomeCard title="Load from file">
      <Text>
        Supports Prosperity 4 log files (JSON format). Download a log file from a submitted algorithm to use it here.
      </Text>
